...
class ApplicationController < ActionController::Base
  ...
  def test_email
    ActionMailer::Base.mail(from: 'Race To 13 <bot@raceto13.com>', to: 'danmadere@gmail.com',
                            subject: 'Test from pool', body: 'we get signal').deliver_later
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up,
                                      keys: [:name, :email, :password, :password_confirmation, :invite_uuid,
